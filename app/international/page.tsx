...
import { MapPin, Clock, Users, Star, Search, Filter, Calendar, ArrowRight, Globe } from "lucide-react";
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl md:text-2xl mb-10 text-white/80 max-w-2xl mx-auto font-medium">
                            Explore the world beyond borders with our curated international travel experiences
                        </p>
                        <div className="flex flex-wrap justify-center gap-6 text-white/60 text-sm font-bold uppercase tracking-widest">
                            <span>{packages.length} Destinations</span>
                ...
                <div className="container mx-auto px-4">
                    {filteredPackages.length === 0 ? (
                        <div className="text-center py-20">
                            <h3 className="text-2xl font-black text-[#1e1f44] mb-2 uppercase tracking-tighter">No destinations found</h3>
                                ...
                                >
                                    <div className="relative w-full h-[220px] flex-shrink-0">
                                        {pkg.images && pkg.images.length > 0 ? (
                                            ...
                                            <div className="w-full h-full bg-gray-100 flex items-center justify-center"><Globe className="h-10 w-10 text-gray-300" /></div>
                                        )}
                                    ...
                                    <div className="p-6 flex flex-col flex-grow">
                                        ...
                                        <div className="flex flex-col gap-3 mt-6 pt-5 border-t border-gray-100">
                                            ...
                                            <Button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    router.push(`/contact?packageName=${encodeURIComponent(pkg.title)}&packageType=international`);
                                                }}
                                            >
                                                Enquiry Now
                                            </Button>
