  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/packages/upcoming-tours',
        heroTitle: 'Ladakh & Umling La Tours',
        heroSubtitle: 'High-altitude motorcycle expeditions through Ladakh and the world\'s highest passes',
        heroImage: img('domestic-north-bike-expeditions'),
        emptyMessage: 'No Ladakh upcoming tours yet',
        accent: 'amber',
        group: 'upcoming-tours',
      },
      {
        ...
        href: '/packages/upcoming-tours',
        heroTitle: 'Cross-Country Motorcycle Tours',
        heroSubtitle: 'Multi-state expeditions across India\'s most iconic riding routes',
        heroImage: img('bike-expeditions-by-destination'),
        emptyMessage: 'No cross-country tours yet',
        accent: 'orange',
        group: 'upcoming-tours',
      },
      {
        ...
        slug: 'upcoming-spiti',
        href: '/packages/upcoming-tours',
        heroTitle: 'Spiti & Himachal Tours',
        heroSubtitle: 'Adventure rides through Spiti Valley and the Himalayas',
        heroImage: img('treks'),
        emptyMessage: 'No Spiti upcoming tours yet',
        accent: 'green',
        group: 'upcoming-tours',
      },
      {
        ...
        href: '/packages/upcoming-tours',
        heroTitle: 'International Motorbike Tours',
        heroSubtitle: 'Cross-border motorcycle adventures in Vietnam, Bhutan, and beyond',
        heroImage: img('international-bike-expeditions'),
        emptyMessage: 'No international upcoming tours yet',
        accent: 'amber',
        group: 'upcoming-tours',
      },
      {
        ...
        href: '/packages/upcoming-tours',
        heroTitle: 'Desert & Heritage Motorcycle Tours',
        heroSubtitle: 'Salt deserts, coastal roads, and cultural heritage routes',
        heroImage: img('domestic-south-bike-expeditions'),
        emptyMessage: 'No desert tours yet',
        accent: 'orange',
        group: 'upcoming-tours',
      },
    ],
